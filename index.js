...
//         {
//             name:"user",
//             message:"Input the Number of Kilometers traveled = ",
//             type:"number"
//         }
//     ]
// )
...
//     }
// }
// console.log(`initial fair = ${fair}rs`)
// console.log(`--------------------------------------------------------------`)
// console.log(`Fixed Amount to be added on any bill = 50rs`)
// console.log(`--------------------------------------------------------------`)
// console.log(`Final fair = ${fair + 50}rs`)
// console.log(`--------------------------------------------------------------`)
import inquirer from "inquirer";
import chalk from "chalk";
let fair = 0;
